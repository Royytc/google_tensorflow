...
class CGAN(object):
    model_name = "CGAN" #模型名称，checkpoint文件夹名称
    ...
    def __init__(self, sess, epoch, batch_size, z_dim, dataset_name, checkpoint_dir, result_dir, log_dir):
        ...
        self.y_dim = 10         # 条件变量的维度
        self.c_dim = 1          # 由于fashion是灰度图，因此维度为1
        self.learning_rate = 0.0002  #优化器的学习率
        self.beta1 = 0.5             #优化器的动量参数
    ...
    def visualize_results(self, epoch):
        ...
        """ 特定条件变量, 随机噪音 """
        n_styles = 10  # 该值不应大于self.batch_size
